...
import tokenvalidate from './tokenvalidation'

const navigation = [
    { name: 'Homepage', href: '/', current: false },
    { name: 'View Tasks', href: "/task", current: false },
                                        ...
                                        {navigation.map((item) => (
                                            <a
                                                ...
                                                className={classNames(
                                                    item.current ? 'text-white hover:bg-blue-700 hover:text-white' : 'text-white hover:bg-blue-700 hover:text-white',
